...
from src.NetworkFitting.reference_trajectory import reference_trajectory_lambda_func_y, calculate_flight_path_angles
...
def test_agent_interaction_evolutionary_algorithms(evolutionary_algorithm_env,
    ...
    while not done_or_truncated:
        actions = evolutionary_algorithm_env.network.forward(state)
