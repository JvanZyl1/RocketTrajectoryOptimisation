...
class ParticleSwarmOptimization_Subswarms(ParticleSwarmOptimization):
    def __init__(self, pso_params, bounds, model, model_name):
        ...
        base_log_dir = f"data/particle_subswarm_optimisation/{model_name}/runs"
        ...
        self.save_dir = f'data/particle_subswarm_optimisation/{model_name}/saves'
    ...
    def run(self):
        ...
        for generation in pbar:
            ...
            if generation % 5 == 0 and generation != 0:
                self.save_swarms(f"{self.save_dir}/particle_subswarm_save.pkl")
