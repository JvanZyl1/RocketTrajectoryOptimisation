...
def compile_rtd_pso(flight_stage = 'subsonic'):
    ...
    subsonic_learning_hyperparameters = [
        # [mach,    max_x_error,    max_vy_error,   max_vx_error,   max_alpha_deg,  alpha_reward_weight,    x_reward_weight,    vy_reward_weight,   vx_reward_weight]
          ...
          [0.5,     30,             4,              4,              0.5,            100,                    100,                100,                100],
          [0.6,     40,             5,              5,              0.5,            100,                    100,                100,                100],
          [0.7,     50,             6,              6,              0.5,            100,                    100,                100,                100],
          [0.8,     60,             7,              7,              0.5,            100,                    100,                100,                100],
          [0.9,     80,             8,              8,              0.5,            100,                    100,                100,                100],
          [1.0,     100,            9,              9,              0.5,            100,                    100,                100,                100],
          [1.1,     100,            10,             10,             0.5,            100,                    100,                100,                100],
    ]
