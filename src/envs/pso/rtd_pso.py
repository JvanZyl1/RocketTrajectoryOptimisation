...
def compile_rtd_pso(flight_stage = 'subsonic'):
    ...
    subsonic_learning_hyperparameters = [
        # [mach,    max_x_error,    max_vy_error,   max_vx_error,   max_alpha_deg,  alpha_reward_weight,    x_reward_weight,    vy_reward_weight,   vx_reward_weight]
          ...
          [0.3,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.4,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.5,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.6,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.7,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.8,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [0.9,     5,             15,              1,              2,              100,                     100,                100,                 100],
          [1.0,     5,             15,              1,              2,               100,                    100,                100,                 100],
          [1.1,     5,             15,              1,              2,               100,                    100,                100,                 100],
    ]
