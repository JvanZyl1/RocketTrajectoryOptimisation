...
def compile_rtd_pso(flight_stage = 'subsonic'):
    ...
    subsonic_learning_hyperparameters = [
        # [mach,    max_x_error,    max_vy_error,   max_vx_error,   max_alpha_deg,  alpha_reward_weight,    x_reward_weight,    vy_reward_weight,   vx_reward_weight]
          [0.0,     1,              1,               1,            0.5,              100,                    100,                50,                  300],
          [0.1,     1,              15,              1,              1,              100,                    100,                50,                  300],
          [0.2,     5,              15,              1,              2,              100,                    100,                50,                  300],
          [0.3,     5,              15,              1,              2,              100,                    100,                100,                 300],
          [0.4,     5,              15,              1.5,            2,              150,                    100,                100,                 300],
          [0.5,     5,              15,              2,              2,              150,                    100,                100,                 300],
          [0.6,     5,              15,              2,              1.75,           150,                    100,                100,                 300],
          [0.7,     5,              15,              2,              1.75,           150,                    100,                100,                 300],
          [0.8,     5,              15,              2,              1.75,           150,                    100,                100,                 300],
          [0.9,     5,              15,              2,              1.75,           150,                    400,                100,                 300],
          [1.0,     5,              15,              2,              1.75,           150,                    400,                100,                 300],
          [1.1,     5,              15,              2,              1.75,           150,                    400,                100,                 300],
    ]
