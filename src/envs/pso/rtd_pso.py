...
def compile_rtd_pso(flight_stage = 'subsonic'):
    ...
    subsonic_learning_hyperparameters = [
        # [mach,    max_x_error,    max_vy_error,   max_vx_error,   max_alpha_deg,  alpha_reward_weight,    x_reward_weight,    vy_reward_weight,   vx_reward_weight]
          ...
          [0.4,     20,             15,              3,              2,              100,                    100,                1000,                100],
          [0.5,     30,             20,              4,              2,              100,                    100,                1000,                100],
          [0.6,     40,             30,              5,              2,              100,                    100,                1000,                100],
          [0.7,     50,             40,              6,              2,              100,                    100,                1000,                100],
          [0.8,     60,             40,              7,              2,              100,                    100,                1000,                100],
          [0.9,     80,             50,              8,              2,              100,                    100,                1000,                100],
          [1.0,     100,            50,              9,              2,              100,                    100,                1000,                100],
          [1.1,     100,            60,             10,              2,              100,                    100,                1000,                100],
    ]
