...
def compile_rtd_pso(flight_stage = 'subsonic'):
    ...
    subsonic_learning_hyperparameters = [
        # [mach,    max_x_error,    max_vy_error,   max_vx_error,   max_alpha_deg,  alpha_reward_weight,    x_reward_weight,    vy_reward_weight,   vx_reward_weight]
          ...
          [0.1,     1,              15,              1,              1,              100,                    100,                200,                 300],
          [0.2,     5,              14,              1,              2,              100,                    100,                50,                  300],
          [0.3,     5,              13,              1,              2,              100,                    100,                100,                 300],
          [0.4,     5,              12,              1.5,            2,              150,                    100,                100,                 300],
          [0.5,     5,              11,              2,              2,              250,                    100,                100,                 300],
          [0.6,     5,              10,              2,              1.75,           250,                    100,                200,                 300],
          [0.7,     5,              10,              2,              1.75,           250,                    100,                200,                 300],
          [0.8,     5,              10,              2,              1.75,           250,                    100,                200,                 300],
          [0.9,     5,              10,              2,              1.75,           250,                    400,                200,                 300],
          [1.0,     5,              10,              2,              1.75,           250,                    400,                200,                 300],
          [1.1,     5,              10,              2,              1.75,           250,                    400,                200,                 300],
    ]
