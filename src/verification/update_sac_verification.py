...
def test_update_sac_integration(save_folder):
    ...
    # Create more diverse prioritised weights that will produce a noticeably different loss
    ...
    # Verify that uniform and prioritised weights produce different losses
