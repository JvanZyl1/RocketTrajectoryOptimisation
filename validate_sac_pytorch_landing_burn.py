...
def main():
    ...
    # Counter for total updates across all episodes
    total_updates = 0
    ...
    for episode in tqdm(range(num_episodes), desc="Training"):
        ...
        # Print episode stats
        print(f"Episode {episode}: Reward = {float(episode_reward):.2f}, Steps = {step+1}, Updates = {updates_this_episode}, Total Updates = {total_updates}")
        ...
        # Force save learning stats every few episodes to ensure no data is lost
        if episode % 5 == 0:
            agent.save_learning_stats(run_id=run_id)
    ...
    # Force save learning stats at the end of training
    print("Saving final learning stats...")
    agent.save_learning_stats(run_id=run_id)
