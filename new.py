...
def full_rocket_inertia(m_s_1 : float,
    ...
    def func(fill_level):
        ...
        I_rocket_hat = I_dry_1 + m_s_1 * (x_dry_1 - x_rocket_tilde)**2 \
            + I_wet_2_intial + m_2 * (x_wet_2_initial - x_rocket_tilde)**2 \
...
class rocket_dimensions:
    def __init__(self,
        ...
        self.nose_density = 5000                         #[kg/m^3] : 304L stainless steel
    ...
    def __call__(self):
        ...
        stage_2_inertia_cog_func, I_wet_2_intial,  x_wet_2_intial, m_2, h_2 \
        ...
        full_rocket_inertia_cog_func = full_rocket_inertia(m_s_1 = self.structural_mass_stage_1,
                                                           ...
                                                           I_dry_1 = I_dry_1,
                                                           m_2 = m_2,
                                                           x_wet_2_intial = x_wet_2_intial,
                                                           I_wet_2_intial = I_wet_2_intial,
                                                           h_1 = h_1,
                                                           h_1_ox = h_ox_1,
                                                           h_1_f = h_f_1,
                                                           m_1_ox = m_ox_1,
