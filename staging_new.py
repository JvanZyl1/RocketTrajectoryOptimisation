...
#  CONSTANTS
# ────────────────────────────────────────────────────────────
MU_EARTH = 3.98602e14     # m³ s⁻² – Earth gravitational parameter

# ────────────────────────────────────────────────────────────
#  FUNCTIONS
# ────────────────────────────────────────────────────────────

def staging_p1_debug(a: float,
                     m_pay: float,
                     dv_loss_a: Sequence[float],
                     dv_loss_d_1: float,
                     dv_d_1: float,
                     v_ex: Sequence[float],
                     eps: Sequence[float]) -> Tuple[Dict[str, float], Dict[str, float]]:
    ...
    def root(k: float) -> float:
        ...
        # use *nominal* ε, not εₐ, in the logarithm (see Jo & Ahn, Eq. 31)
        try:
