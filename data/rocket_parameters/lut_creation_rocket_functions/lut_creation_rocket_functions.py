...
propellant_mass_stage_1 = float(sizing_results['Propellant mass stage 1 (ascent)']) \
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_0/x_cog_inertias.csv', 'w') as file:
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_0/d_cp_cgs.csv', 'w') as file:
    writer = csv.writer(file)
    # Column names
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_0/inertias.csv', 'w') as file:
    writer = csv.writer(file)
    # Column names
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_2/x_cog_inertias.csv', 'w') as file:
    writer = csv.writer(file)
    # Column names
    writer.writerow(['Propellant mass [kg]', 'X cog inertia [m]'])
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_2/d_cp_cgs.csv', 'w') as file:
    writer = csv.writer(file)
    # Column names
    writer.writerow(['Propellant mass [kg]', 'd_cp_cg [m]'])
...
with open('data/rocket_parameters/lut_creation_rocket_functions/subrocket_2/inertias.csv', 'w') as file:
    writer = csv.writer(file)
    # Column names
    writer.writerow(['Propellant mass [kg]', 'Inertia [kg m^2]'])
