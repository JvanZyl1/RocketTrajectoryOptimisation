...
legend_labels = {
    "alpha_lr_0.001": r"$\alpha_{\log(\alpha)}$ = 0.001",
    "alpha_lr_0.0003": r"$\alpha_{\log(\alpha)}$ = 0.0003",
    "alpha_lr_0.0001": r"$\alpha_{\log(\alpha)}$ = 0.0001"
}
...
plt.savefig(os.path.join(base_path, "PostProcessedResults/temperature_comparison_1000_episodes.png"), dpi=300)
plt.show()
